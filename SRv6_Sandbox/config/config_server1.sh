...
# Install Snort
cd ~/
wget --no-check-certificate https://snort.org/downloads/snort/daq-2.0.7.tar.gz
wget --no-check-certificate https://snort.org/downloads/snort/snort-2.9.20.tar.gz
